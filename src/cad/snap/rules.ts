...
import { compareVecWithEps, copyVec, crossP, dist2, dotP, type Vec2 } from "../models/sketch/vectors";
import type { CircleLite, SegmentLite } from "../models/sketch/primitives";
